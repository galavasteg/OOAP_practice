...
Переопределённый метод get_melee_weapon() родительского класса Knight
возвращает значение типа, являющемся потомком типа значения,
...
контравариантности их зависимых типов (по-умолчанию, в generic
types инвариантны в своих типах).
