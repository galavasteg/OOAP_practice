...
class HT2PartialFilledTests(HTTestsBase):
    ...
    def test_02_partial_filled_put_bad_exists(self):
        self.ht.put('ab')
    ...
    def test_03_partial_filled_put_bad_collision(self):
        self.ht.put('ba')
    ...
    def test_05_partial_filled_remove_bad(self):
        self.ht.remove('val')
    ...
    def test_06_partial_filled_remove_bad_rm_collision(self):
        self.ht.remove('ba')
