...
"""
2.2. Почему операция tail не сводима к другим операциям (если исходить
...
"""
2.3. Операция поиска всех узлов с заданным значением, выдающая список
таких узлов, уже не нужна. Почему?
ОТВЕТ:
Такую операцию можно выразить с помощью find(). Таким образом
открывается возможность итерировать по искомым объектам.
Да и выражать одну сложную операцию через другую сложную операцию в
абстрациях не стоит.
"""
